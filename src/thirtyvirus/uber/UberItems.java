...
public class UberItems extends JavaPlugin {
    ...
    public void registerUberItems() {
        ...
        items.put("lunch_box", new lunch_box(this,2, UberRarity.UNFINISHED, "Lunch Box", Material.CONDUIT, false, false, false, Arrays.asList(new UberAbility("Gluttony", AbilityType.NONE, "Automatically feeds you\n" + ChatColor.DARK_GRAY + "(right click to insert food)")))); itemIDs.put(2, "lunch_box");
