...
public class UberItemTemplate extends UberItem {
	...
	public UberItemTemplate(int id, UberRarity rarity, String name, Material material, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities) {
